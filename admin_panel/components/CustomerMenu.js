    ...
    <Box sx={{ display: 'flex' }}>
      ...
      <Drawer variant="permanent" open={open}>
        ...
        <List>
            ...
            <ListItem key="logout" disablePadding sx={{ display: 'block' }} onClick={()=>menuHandler(4)}>
              <ListItemButton sx={{ minHeight: 48,justifyContent: open ? 'initial' : 'center',px: 2.5, }}  >
                <ListItemIcon sx={{ minWidth: 0,mr: open ? 3 : 'auto',justifyContent: 'center',}}>
                   <LogoutSharpIcon /> 
                </ListItemIcon>
      ...
      <Box component="main" sx={{ flexGrow: 1, p: 3 }}>
        <DrawerHeader />
        {
          menu==1?<CustomerDashboard></CustomerDashboard>:menu==2?<CustomerInvesments/>:<CustomerProfile/>
        }
      </Box>
    </Box>
  );
